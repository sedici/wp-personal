...
{
    $input = '<div clas="inptut-personal">';
    ...
    foreach ($args as $value) {
        ...
        if ($value['type'] != 'textarea') {
            ...
            $input .= "<div class=''><textarea type= text  name=" . $value['name'] . " placeholder='" . $value['placeholder'] . "' value='" . $value['default_value'] . "'>".$value['default_value'] ."</textarea></div>";
        }
    }
    return $input . '</div>';
}
